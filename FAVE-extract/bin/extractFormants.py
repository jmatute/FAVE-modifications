...
def extractPortion(wavFile, vowelWavFile, beg, end, soundEditor, debug):
    ...
    if soundEditor == 'sox':  # this is the default setting, since it's faster
        ...
        print "No sound editor to extract audio "
        pass
...
def extractFormants(wavInput, tgInput, output, opts, currentSpeaker, allOutputFiles, SPATH='', PPATH=''):
    ...
    if PRAATNAME == "Praat" and not programExists(PRAATNAME):
       print "Praat defined but not found by command"
       if programExists("praat"):
          PRAATNAME = "praat"
    ...
    for (wavFile, tgFile, outputFile) in zip(wavFiles, tgFiles, outputFiles):
        ...
        print "Going for the words Total Words " ,len(words)
